  ...
  def default_meta_tags
    {
      ...
      og: { title: 'Create, Share and Learn', description: 'Mattrab is the interactive web application where +2 students create, share and learn from the notes, ask questions and answer them.', type: 'website', url: 'https://www.askmattrab.com', image: asset_path('mricon.png') },
